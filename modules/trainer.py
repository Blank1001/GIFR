...
class NERTrainer:
    ...
    def _step(self, batch):
        input_ids, token_type_ids, attention_mask, image_features, labels, num_images, image_attention_mask = batch

        output = self.model(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids,
                            img_features=image_features, labels=labels, num_images=num_images,
