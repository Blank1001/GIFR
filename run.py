...
from models.BERTModels import GIFR
...
if __name__ == '__main__':
    ...
    fileHandler = logging.FileHandler(f'./logs/log_{args.dataset}.txt', mode='a', encoding='utf8')
